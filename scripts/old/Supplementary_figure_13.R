## A-----------------------------------------------------------------------------
# Pre-run the Parts 1-4 from the [Mouse Visium Brain tutorial](https://giottosuite.readthedocs.io/en/latest/subsections/datasets/mouse_visium_brain.html)
...
## C -----------------------------------------------------------------------------
# Pre-run the Parts 1-7 from the [merFISH Mouse Hypothalmic Preoptic Region tutorial](https://giottosuite.readthedocs.io/en/latest/subsections/datasets/merFISH_hypot_preopt_region.html)
