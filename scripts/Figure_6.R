...
instructions(g, 'save_dir') <- "scripts/FIGURE/F6/"
...
# plot knn projected leiden clusters across the whole dataset at hex 100
spatInSituPlotPoints(
  gobject = g,
  spat_unit = 'hex100',
...
# visualize some raw transcripts
spatInSituPlotPoints(
  brain,
  show_polygon = FALSE,
  feats = list(rna = c(
...
# append SVG information into metadata to be used during PCA construction
...
# visualize niche clustering smoothened annotations
...
# Plot transcripts and pseudovisium spots overlaid
spatInSituPlotPoints(
  brain,
  feats = list(rna = c(
    "Hmgb2",
