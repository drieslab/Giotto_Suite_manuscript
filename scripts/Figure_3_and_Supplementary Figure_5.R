...
## This example script download original Xenium data to './Xenium/'
## This example script download original Visium data to './Visium/'

dir.create("data/Visium")
dir.create("data/Xenium")

download.file(url = "https://cf.10xgenomics.com/samples/spatial-exp/2.0.0/CytAssist_FFPE_Human_Breast_Cancer/CytAssist_FFPE_Human_Breast_Cancer_raw_feature_bc_matrix.tar.gz",
              destfile = "data/Visium/CytAssist_FFPE_Human_Breast_Cancer_raw_feature_bc_matrix.tar.gz")
download.file(url = "https://cf.10xgenomics.com/samples/spatial-exp/2.0.0/CytAssist_FFPE_Human_Breast_Cancer/CytAssist_FFPE_Human_Breast_Cancer_spatial.tar.gz",
              destfile = "data/Visium/CytAssist_FFPE_Human_Breast_Cancer_spatial.tar.gz")
...
download.file(url = "https://cf.10xgenomics.com/samples/xenium/1.0.1/Xenium_FFPE_Human_Breast_Cancer_Rep1/Xenium_FFPE_Human_Breast_Cancer_Rep1_if_image.ome.tif",
              destfile = "data/Xenium/Xenium_FFPE_Human_Breast_Cancer_Rep1_if_image.ome.tif")
download.file(url = "https://cf.10xgenomics.com/samples/xenium/1.0.1/Xenium_FFPE_Human_Breast_Cancer_Rep1/Xenium_FFPE_Human_Breast_Cancer_Rep1_if_imagealignment.csv",
              destfile = "data/Xenium/Xenium_FFPE_Human_Breast_Cancer_Rep1_if_imagealignment.csv")

untar(tarfile = "data/Visium/CytAssist_FFPE_Human_Breast_Cancer_raw_feature_bc_matrix.tar.gz",
      exdir = "data/Visium/")
untar(tarfile = "data/Visium/CytAssist_FFPE_Human_Breast_Cancer_spatial.tar.gz",
      exdir = "data/Visium/")
untar(tarfile = "data/Xenium/Xenium_FFPE_Human_Breast_Cancer_Rep1_outs.zip",
      exdir = "data/Xenium/")
...
results_folder <- "results/figure_3/"
...
spatInSituPlotPoints(xen,
    ...
    show_legend = FALSE,
    save_param = list(
        save_name = "f3c_rna_prot_cell_zoom",
        base_height = 10,
        base_width = 10
    )
)
...
ggsave(multiscale_mbv,
    filename = file.path(results_folder, "f3e_bivariate_morans.png"),
    width = 5, height = 4
)
...
ggsave(cor_perc,
    filename = file.path(results_folder, "cor_perc.pdf"),
    width = 8.5, height = 4
)
...
ggsave(rankplot,
    filename = file.path(results_folder, "f3f_rankplot.pdf"),
    width = 8.5, height = 4
)
...
ggsave(loessplot,
    filename = file.path(results_folder, "f3g_loess.pdf"),
    width = 5, height = 4
)
