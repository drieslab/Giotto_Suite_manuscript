...
IF_xen <- read10xAffineImage(
    file = paste0(Xenium_dir, "/Xenium_FFPE_Human_Breast_Cancer_Rep1_if_image.ome.tif"),
...
join_xen <- doLeidenClusterIgraph(
    gobject = join_xen,
    spat_unit = "cell",
    feat_type = "rna",
    resolution = 0.5,
...
ggpubr::ggviolin(polygonal_areas,
